    ...
    <div className="border border-border hover:border-accent/30 transition-colors duration-300">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="px-6 pb-5 text-[13px] text-text leading-relaxed border-t border-border/50 pt-4">
              {faq.a}
            </div>
          </motion.div>
        )}
      ...
      <section className="section-padding bg-white">
        <div className="max-w-[800px] mx-auto px-6">
          <div className="space-y-10">
            {faqCategories.map((cat) => (
              <div key={cat.category}>
                <h3 className="text-[11px] tracking-[0.3em] uppercase text-accent mb-5 font-medium">{cat.category}</h3>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="mt-16 text-center p-12 bg-black text-white"
          >
            <h3 className="text-2xl font-serif font-bold mb-3">Still Have Questions?</h3>
            <div className="w-[40px] h-[2px] bg-accent mx-auto mb-4" />
            <p className="text-white/50 text-[14px] mb-8">
              Can&apos;t find what you&apos;re looking for? Our team is here to help.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:08184118997" className="inline-flex items-center justify-center gap-2 bg-accent text-black px-8 py-3.5 text-[13px] font-bold tracking-wider uppercase hover:bg-accent-dark transition-all duration-300">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                Call Us: 08184118997
              </a>
              <a href="mailto:info@magre.ng" className="inline-flex items-center justify-center gap-2 bg-white/10 text-white border border-white/20 px-8 py-3.5 text-[13px] font-bold tracking-wider uppercase hover:bg-white/20 transition-all duration-300">
                Email Us
              </a>
            </div>
          </motion.div>
