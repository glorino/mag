            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-text leading-relaxed">
                  By accessing and using the MAGRE website ({BUSINESS.siteUrl.replace("https://", "")}), you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, please do not use our website.
                </p>
              </div>
