    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-[15px] font-semibold text-white tracking-wide">Create Account</h1>
          <p className="text-white/40 text-[13px] mt-2">Join the MAGRE community</p>
        </div>
        ...
        <div className="bg-[#111] border border-white/10 p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-[11px] font-semibold text-white/50 mb-2 tracking-[0.1em] uppercase">Full Name</label>
              <input
                type="text"
                name="name"
                value={form.name}
            ...
            <div>
              <label className="block text-[11px] font-semibold text-white/50 mb-2 tracking-[0.1em] uppercase">Phone Number</label>
              <input
                type="tel"
                name="phone"
                value={form.phone}
          ...
          <p className="text-center text-white/40 text-[13px]">
            ...
            <Link href="/login" className="text-accent hover:text-accent-dark transition-colors font-semibold">
              Sign in
            </Link>
          </p>
        </div>
