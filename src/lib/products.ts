...
export const products: Product[] = [
  {
    id: 1,
    name: "Ankara Wrap Shirt",
    price: "₦28,500",
    priceNum: 28500,
    category: "Shirt",
    badge: "Bestseller",
    image: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=600&h=800&fit=crop",
    description: "A beautifully crafted wrap shirt that combines comfort with African elegance. Perfect for casual outings or work wear.",
  ...
  {
    id: 6,
    name: "Printed Boxer Short",
    price: "₦12,000",
    priceNum: 12000,
    category: "Nicker",
    image: "https://images.unsplash.com/photo-1485968579580-b6d095142e6e?w=600&h=800&fit=crop",
    description: "Relaxed-fit boxer shorts with African print. Perfect for lounging or everyday comfort.",
    sizes: ["XS", "S", "M", "L", "XL", "XXL"],
    details: ["Soft cotton fabric", "Relaxed fit", "Elastic waistband", "Machine washable"],
  },
  {
    id: 7,
    name: "Off-Shoulder Ruffle Shirt",
    price: "₦38,000",
    priceNum: 38000,
    category: "Shirt",
    badge: "Premium",
    image: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=600&h=800&fit=crop",
    description: "A statement off-shoulder shirt with ruffle details. Bold design meets modern elegance.",
    sizes: ["XS", "S", "M", "L", "XL"],
  ...
  {
    id: 10,
    name: "Embroidered Tunic Shirt",
    price: "₦42,000",
    priceNum: 42000,
    category: "Shirt",
    image: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=600&h=800&fit=crop",
    description: "Hand-embroidered tunic shirt with flowing silhouette. Perfect for special occasions.",
    sizes: ["XS", "S", "M", "L", "XL"],
  ...
  {
    id: 12,
    name: "Silk Kimono Knicker",
    price: "₦20,000",
    priceNum: 20000,
    category: "Nicker",
    image: "https://images.unsplash.com/photo-1506629082955-511b1aa562c8?w=600&h=800&fit=crop",
    description: "Luxurious silk kimono-style knicker with tie waist. Ultimate comfort meets elegance.",
    sizes: ["XS", "S", "M", "L", "XL"],
