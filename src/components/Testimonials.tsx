    ...
    <section className="section-padding bg-charcoal text-white">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="text-center mb-12">
          <p className="text-[11px] tracking-[0.3em] uppercase text-white/50 mb-2">Testimonials</p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className="text-white/70 text-[14px] leading-relaxed mb-6 italic">
                &ldquo;{t.text}&rdquo;
              </p>
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-white font-bold text-[13px]">
                  {t.name[0]}
                </div>
                <div>
